        ; 8080 assembler code
        .hexfile MicroKernelRace.hex
        .binfile MicroKernelRace.com
...
scStack:     dw 1023
initStack:    dw 600
	org 2000H  ; allocate mailbox
MailBox1:   ds 53H      ; id =1
MailBox2:   ds 53H      ; id =2
	org 28H    ; this address is reserved for scheduler 

JMP schedular 
JMP exitProcess  

sender:     dw  'SenderRace.com', 00H
receiver:   dw  'ReceiverRace.com', 00H
