...
void CPU8080::onInterrupt() {
    ...
    memory->physicalAt(int_buffer + 2) = state->b;
    memory->physicalAt(int_buffer + 1) = state->c;

    memory->physicalAt(int_buffer + 4) = state->d;
    memory->physicalAt(int_buffer + 3) = state->e;
    memory->physicalAt(int_buffer + 6) = state->h;
    memory->physicalAt(int_buffer + 5) = state->l;
